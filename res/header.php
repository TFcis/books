<header class="navbar navbar-static-top bs-docs-nav" id="top" style="background-color: #FFFFFF; margin: 0;">
	<div class="container">
		<div class="navbar-header" style="background-color: #FFFFFF;">
			...
			<a href="https://github.com/TFcis/books" target="_blank" class="navbar-brand">
				<div style="float: left;">
					<img src="../res/icon.png" alt="臺南一中資訊社TFcis" height="30">
				</div>
				<div style="float: left;">
					&nbsp;&nbsp;<span style="font-weight: bold; font-size: 18px; font-family: '標楷體';">電子化圖書管理系統</span><br>
				</div>
			</a>
		</div>
